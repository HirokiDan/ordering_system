<?php
    ...
    // DELETE PRODUCTS FUNCTIONS
        ...
        //FETCH all Values
        $tbl_users_id = $_POST['tbl_users_id'];
        $name = $_POST['name'];
        $phone = $_POST['phone'];
        $email = $_POST['email'];
        ...
        $update_query = "UPDATE tbl_users SET 
            ...
            WHERE id='$tbl_users_id' 
        ";
        $update_query_run = mysqli_query($con, $update_query);

        if ($update_query_run){
            redirect("user.php?id=$tbl_users_id", "Updated Successfully!");
        }else{
            redirect("user.php?id=$tbl_users_id", "Item Updated Successfully!");
        }
    }
        ...
        $tbl_users_id = mysqli_real_escape_string($con, $_POST['tbl_users_id']);

        $tbl_users_query = "SELECT * FROM tbl_users WHERE id='$tbl_users_id' ";
        $tbl_users_query_run = mysqli_query($con, $tbl_users_query);
        $tbl_users_data = mysqli_fetch_array($tbl_users_query_run);

        $delete_query = "DELETE FROM tbl_users WHERE id='$tbl_users_id' ";
        $delete_query_run = mysqli_query($con, $delete_query);
